...
const Github = () => {
    return (
      <>
          <section className="text-gray-600 body-font" id="Github">
              <div className="container mx-auto flex px-5 pb-24 md:flex-row flex-col items-center">
                  ...
                  <div className="flex justify-center">
                      <button className="inline-flex text-white bg-indigo-500 border-0 py-4 px-16 focus:outline-none hover:bg-indigo-600 rounded-full font-bold text-lg">
                            <Link to="https://github.com/D-Curse/MajorProject">
                                GITHUB
                            </Link>
                        </button>
                  </div>
